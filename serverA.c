...
int main(int argc, char *argv[]){  
    ...
    printf("The server A is up and running using UDP on port 21422 \n");
    while(1){  
        ...
        FILE *fp = fopen("backendA.txt","r");
        if((fp = fopen("backendA.txt","r")) == NULL) //
        { 
        printf("error!"); 
         return -1; 
        } 
        ...
        fclose(fp); 
        printf("The serverA has found <%d> match\n", m);
